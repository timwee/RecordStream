package Recs::DomainLanguage::Executor;
...
sub import_registry
{
    ...
    for my $token (Recs::DomainLanguage::Registry::get_tokens())
    {
        my $subref = sub
        {
            my $value = Recs::DomainLanguage::Registry::evaluate($token, @_);
...
sub exec
{
    ...
    $__MY__code = Recs::Executor->transform_code($__MY__code);
